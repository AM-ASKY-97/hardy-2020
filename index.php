...
<div class="container-fulid">
    <div class="row">
        <div class="col-xl-2  bg-dark d-xl-block collapse" id="navbarSupportedContent">
            ...
            <div>
                <button class="btn" onclick="loadfiles('view_student','loadArea')"><i class="fas fa-user-graduate "></i><span>View Students</span></button>
            </div>
...
<!-- Footer -->
<div class="row text-center">
                <div class="col-xl bg-black text-white text-uppercase pa10">
